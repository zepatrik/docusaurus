...
export default () => ({
  elements: {
    sidebar: '.sidebar__-_-_-docusaurus-theme-bootstrap-src-theme-DocSidebar-',
    pageLink: '.page-link',
    mobileMenuSidebar:
      '.sidebarFAB__-_-_-docusaurus-theme-bootstrap-src-theme-DocSidebar-',
    mobileSidebar:
      '.sideMenu__-_-_-docusaurus-theme-bootstrap-src-theme-DocSidebar-',
  },
  mobileViewports: [
    'iphone-4',
    'iphone-5',
